...
def gettagsbycharacter(links):
    ...
    for link in links:
        ...
        copyright = content.xpath('//*[@id="tag-list"]/li[@class="tag-type-copyright"]/a/text()')
        _source = ifempty(content.xpath('//*[@id="tag-list"]/li[text()="Source: "]/a/@href'))[0]
        _size = ifempty(content.xpath('//*[@id="tag-list"]/li[contains(text(),"Size: ")]/text()'))[0]
        _uploader = ifempty(content.xpath('//*[@id="tag-list"]/li[contains(text(),"Posted: ")]/a/text()'))[0]
        _tags = content.xpath('//*[@id="tag-list"]/li[@class="tag-type-general"]/a/text()')
        ...
        if not(copyright[0:1]):
            ...
            chars = content.xpath('//*[@id="tag-list"]/li[@class="tag-type-character"]/a/text()')
            for i in chars:
                if i not in tags:
                    tags[i] = {}
                    tags[i]['tags'] = []
        ...
        (last['source'],last['size'],last['uploader'],last['tags']) = (_source,_size,_uploader,_tags)
    return tags
